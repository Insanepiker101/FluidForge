-- This is the prototype file for the armor fire armor
-- Create the fire Armor object in the table FluidForge, this object will be used to append to the main process using data:extend 
